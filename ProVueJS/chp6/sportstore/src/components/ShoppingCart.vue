<template>
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col mt-2">
            <h2 class="table table-bordered table-striped p-2">Your Cart</h2>
            <table class="table table-bordered tab;e -stripped p-2">
              <thead>
                <tr>
                  <th>Quantity </th>
                  <th>Product</th>
...
<!--
A prefix is required for mapping getters, mutations and action of 'independent' data store modules:
e.g
1) ...mapGetters({totalProce: "cart/totalPrice"})
2) ...mapMutation({remove: 'cart/removeProduct})
The prefix is "cart" andd it represent the data store defined in cart.js.

However, for state, a differrent approach is required for:
...mapState({line: state  => state.cart.lines})
-->