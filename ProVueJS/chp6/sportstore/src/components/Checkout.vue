...
<!--
The $v object defines a $touch method, which marks all of the elements as dirty, as though the user
had edited them
This is a useful feature to trigger validation as the result of a user action, while not usually
displaying validation messages until the user interacts with an input element.
-->