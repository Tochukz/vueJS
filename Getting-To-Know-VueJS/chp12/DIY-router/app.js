...
var app = new Vue({
    ...
    methods: {
        navigate: function($event) { console.log($event); console.log(`Target: ${$event.target}`); console.log(`Hash: ${event.target.hash}`);
    ...
    template: `
        <div>
            <ul>
                <li>
                   <a href="#/" v-on:click="navigate">Main</a>
                </li>
                <li>
                    <a href="#/contact-us" v-on:click="navigate">Contact Us</a>
                </li>
            </ul>
